 ...
 * 2022-01-20T19:08:49.896+03:00
 * Generated source version: 3.4.5
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:/Users/aleksandr.shleyko/reps/java_learning2021/soap-example/src/main/resources/ipservice.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/aleksandr.shleyko/reps/java_learning2021/soap-example/src/main/resources/ipservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/aleksandr.shleyko/reps/java_learning2021/soap-example/src/main/resources/ipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
